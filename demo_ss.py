...
def parse_args():
    ...
    parser.add_argument('--image_parent_dir', dest='image_parent_dir',
                        help='parent directory of directories to load images for demo',
                        default="")
    parser.add_argument('--save_dir', dest='save_dir',
                        help='directory to save results',
                        default="images_det")
    parser.add_argument('--json_save_dir', dest='json_save_dir',
                        help='directory to save bounding boxes as json',
                        default="bb_json")
    ...
    for image_dir in tqdm(image_dirs, desc=f'Going through {len(image_dirs)} image directories to extract bbox...'):
        ...
        with torch.no_grad():
            ...
            while (num_images >= 0):
                ...
                if vis:
                    # visualization
                    bbs[str(imglist[num_images][:-4])] = hand_dets
